const strings = {
  he: {
    ...
    'sim.back':               '‹ חזרה',
    'sim.tabAll':             'כולל',
    'sim.horizon':            'אופק זמן',
    'sim.years':              '{n} שנים',
    'sim.projTotal':          'שווי צפוי',
    'sim.monthlyTotal':       'הפקדה חודשית',
    'sim.avgReturn':          'תשואה ממוצעת',
    'sim.currentTrajectory':  'מסלול נוכחי',
    'sim.scenario':           'תרחיש',
    'sim.reset':              'איפוס',
    'sim.sliderReturn':       'תשואה צפויה (%)',
    'sim.sliderFee':          'דמי ניהול (%)',
    'sim.sliderMonthly':      'הפקדה חודשית (₪)',
    'sim.sliderSalary':       'שכר ברוטו (₪)',
    'sim.sliderEmpContrib':   'הפרשת עובד (%)',
  ...
  en: {
    ...
    'sim.years':              '{n} Years',
    'sim.projTotal':          'Projected Total',
    'sim.monthlyTotal':       'Monthly Contribution',
    'sim.avgReturn':          'Avg Return',
    'sim.currentTrajectory':  'Current Trajectory',
    'sim.scenario':           'Scenario',
    'sim.reset':              'Reset',
    'sim.sliderReturn':       'Expected Return (%)',
    'sim.sliderFee':          'Management Fee (%)',
    'sim.sliderMonthly':      'Monthly Contribution (₪)',
    'sim.sliderSalary':       'Gross Salary (₪)',
    'sim.sliderEmpContrib':   'Employee Contrib (%)',
